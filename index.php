        ...
        <section id="contact"
        	...
        	<form>
			  ...
			  <div class="mb-3">
			    ...
			    <div id="emailHelp" class="form-text">Não divulgamos seu email.</div>
			  </div>
			  <div class="mb-3">
			  ...
			  <button type="submit" class="btn btn-primary login-button" style="margin-left:0%;">Enviar</button>
			</form>
        </section>
